...
namespace iQuest.BooksAndNews.Application.Publishers
{
    ...
    public class PrintingOffice
    {
        ...
        public event BookPrintedDelegate BookPrinted;

        public event NewspaperPrintedDelegate NewspaperPrinted;

        public delegate void BookPrintedDelegate(Book book);

        public delegate void NewspaperPrintedDelegate(Newspaper newspaper);
