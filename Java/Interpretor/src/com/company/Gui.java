...
public class Gui extends Application {
    ...
    void UpdateAll()
    {
        ...
        else
        {
            ...
            exeStack.setItems(FXCollections.observableList(a.getExeStack().toListReversed()));
        }
    }
    ...
    public void RunProgram(IStatement selectedItem)
    {
        ...
        Repo repo = new Repo(programstate, "program.log");
...
//            Controller ctr6 = new Controller(repo6);
            ...
            var p9 = IStatement.concat(
                    new DeclarationStmt("a",new TypeInt()),
                    new DeclarationStmt("b",new TypeInt()),
                    new DeclarationStmt("c",new TypeInt()),
                    new AssignStmt("a",new ValueExpression(new ValueInt(1))),
                    new AssignStmt("b",new ValueExpression(new ValueInt(2))),
                    new AssignStmt("c",new ValueExpression(new ValueInt(5))),
                    new SwitchStmt(
                            new ArithmeticExpression(ArithmeticOp.MUL,new VaribleExpression("a"),new ValueExpression(new ValueInt(10))),
                            new ArithmeticExpression(ArithmeticOp.MUL,new VaribleExpression("b"),new VaribleExpression("c")),
                            IStatement.concat(new PrintStmt(new VaribleExpression("a")),new PrintStmt(new VaribleExpression("b"))),
                            new ValueExpression(new ValueInt(10)),
                            IStatement.concat(new PrintStmt(new ValueExpression(new ValueInt(100))),new PrintStmt(new ValueExpression(new ValueInt(200)))),
                            new PrintStmt(new ValueExpression(new ValueInt(300)))
                            ) ,
                    new PrintStmt(new ValueExpression(new ValueInt(300))));
        ...
        ObservableList<IStatement> items = FXCollections.observableArrayList (p4,p5,p6,p7,p8,p9);
